                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Search plans...">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-outline-danger"><i class="bi bi-x"></i> Return</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>GAD002</td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-outline-warning"><i class="bi bi-arrow-clockwise"></i> Reopen</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
